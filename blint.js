...
function getOptions(value) {
  ...
  for (var prop in defaultOptions) {
    if (value && Object.prototype.hasOwnProperty(value, prop))
...
function checkFile(fileName, options) {
  ...
  var allowedGlobals = Object.create(topScope.vars), m;
